...
//
//    private Map<String, BoothMessage> targetBeacons;
...
//    }
//
//    public void getTaskList(final List<BoothMessage> beacons) {
//        // 初始化任务集合
//        targetBeacons = new HashMap<>();
//        for (BoothMessage beacon : beacons) {
...
//                        BoothMessage boothMessage = targetBeacons.get(beacon.getSerialNumber());
//                        boothMessage.setDistance(beacon.getAccuracy());
//                        boothMessage.setApproach(true);
//                        targetBeacons.put(beacon.getSerialNumber(), boothMessage);
...
//                        BoothMessage boothMessage = targetBeacons.get(beacon.getSerialNumber());
//                        boothMessage.setApproach(false);
//                        ((Activity) context).runOnUiThread(new Runnable() {
//                            @Override
//                            public void run() {
//                                iView.updateAdapter();
...
//    }
//
//    public void createQECode(List<BoothMessage> list, String userName, String telNumber) {
//
...
//                .append(telNumber)
//                .append("\n\n");
//        for (BoothMessage boothMessage : list) {
//            content/*.append(boothMessage.getMacId())
//                    .append("\n")*/
//                    .append(boothMessage.getAnswer())
//                    .append("\n\n");
//        }
//
